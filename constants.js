...
const IRIS_INPUT_DATA = IRIS_DATA.map((x) => [x[1]/10, x[2]/5, x[3]/8, x[4]/4,] )

const LABEL_MAP = ['Iris-setosa','Iris-versicolor','Iris-virginica']
 
const IRIS_LABEL_DATA = IRIS_DATA.map((x) => LABEL_MAP.indexOf(x[5]))

const IRIS_COLOR_INDEX = ['#673ab7','#9c27b0','#9fa8da',]
